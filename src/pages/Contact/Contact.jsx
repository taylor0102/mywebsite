...
const Contact = () => {
    ...
    const [copyText, setCopyText] = useState("littletontaylor18@gmail.com")
            ...
            <div className="Contact-Container flex">
                <FadeUp className="Contact-Left flex col">
                    <div className="Contact-Social flex">
                        <a href="https://www.facebook.com/" className="Contact-Icon facebook" title="Facebook" target="_blank" rel="noreferrer">
                            <img src={FaceBookIcon} alt="FaceBook" width={30} height={30} />
                        </a>
                        <a href="https://www.instagram.com/" className="Contact-Icon instagram" title="Instagram" target="_blank" rel="noreferrer">
                            <img src={InstagramIcon} alt="Instagram" width={30} height={30} />
                        </a>
                        <a href="mailto:littletontaylor18@gmail.com" className="Contact-Icon gmail" title="Gmail" target="_blank" rel="noreferrer">
                            <img src={GmailIcon} alt="Gmail" width={30} height={30} />
                        </a>
                        <a href="https://x.com/" className="Contact-Icon twitter" title="Twitter" target="_blank" rel="noreferrer">
                            <img src={TwitterIcon} alt="Twitter X" width={30} height={30} />
                        </a>
                        <a href="@taylor950102" className="Contact-Icon discord" title="Discord" target="_blank" rel="noreferrer">
