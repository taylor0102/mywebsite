...
const Projects = () => {
  ...
  return (
    <section id="projects" className="Projects-Main">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  window.history.pushState(
                    {},
                    "",
                    `#projects/${obj?.Name?.toLowerCase()}`
                  );
                }}
              >
                <img
                  className="Projects-Shot"
                  src={obj.Shot}
                ...
                <div className="Projects-Title flex">
                  ...
                  <div className="flex">
                    {obj.Status === "development" && (
                      <div className="flex gap05 ProjectsDev-Warning">
                        <svg
      ...
      <div
        style={showMiscProjects ? { padding: "2em 0" } : { paddingTop: "2em" }}
        className="Projects-Misc flex"
      >
        <button
          className="flex gap"
          onClick={() => setShowMiscProjects((prev) => !prev)}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width={50}
        ...
        {ProjectsList?.map((obj, index) => {
          ...
          if (showMiscProjects)
            return (
              <FadeUp
                width="100%"
                className="Projects-MiscCardMain flex col"
                key={index}
              >
                <div className="Projects-MiscCard flex">
                  <div
                    className="Projects-MiscInfo flex"
                    onClick={() => {
                      setSelectedProject(obj);
                      window.history.pushState(
                        {},
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="Projects-Link Misc-Link flex"
                  >
                    <img
                      src={LinkArrow}
                      alt="LinkArrow"
