        ...
        <>
            ...
            <footer id='footer' className='Footer-Main flex col'>
                ...
                <div className="Footer-Links flex">
                    ...
                    <a href="https://github.com/taylor0102" target="_blank" rel="noreferrer">
                        <img src={GithubIcon} alt="Discord" width={30} height={30} />
                    </a>
                    <a href="@taylor950102" target="_blank" rel="noreferrer">
                        <img src={DiscordIcon} alt="Discord" width={30} height={30} />
                    </a>
                </div>

                <p>© Copyright 2023 Taylor</p>
            </footer>
        </>
    )
}
